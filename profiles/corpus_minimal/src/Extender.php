...
namespace Drupal\corpus_minimal;
...
class Extender {
  ...
  public function getInfo() {
    ...
    // `sites/all`.
    $paths[] = $this->sitePath . '/corpus_minimal.extend.yml';
    $paths[] = $this->root . '/sites/all/corpus_minimal.extend.yml';
  ...
  /**
   * Returns the list of extensions to enable.
   *
   * @return string[]
  ...
  public function getExtensions() {
    ...
    return isset($info['corpus_extensions']) ? $info['corpus_extensions'] : FALSE;
  }

  /**
   * Returns the list of sub-components that should NOT be installed.
   *
   * @return string[]
